...
Route::post('payUpdate/{pay}' ,'PayController@update')->name('pay.update');
Route::post('payDestory/{pay}' ,'PayController@destory')->name('pay.destory');
...
Route::post('incomeUpdate/{income}', 'IncomeController@update')->name('income.update');
Route::post('incomeDestory/{income}', 'IncomeController@destory')->name('income.destory');
...
Route::post('noteUpdate/{note}', 'NoteController@update')->name('note.update');
Route::get('/editNote/{note}', 'NoteController@edit')->name('note.edit');
Route::post('noteDestory/{note}', 'NoteController@destory')->name('note.destory');
